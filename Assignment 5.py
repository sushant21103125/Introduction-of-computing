...
lbl_1=Label(win,text='ENTER ORIGINAL PRICE',bg='sky blue',relief='ridge',padx=3,pady=3,bd=3,font=('calibre',14,'bold','underline'))
lbl_1.grid(row=1,column=1,padx=10,pady=10)
lbl_2=Label(win,text="ENTER NET PRICE",bg='sky blue',relief='ridge',padx=3,pady=3,bd=3,font=('calibre',14,'bold','underline'))
...
# FUNCTION FOR DESPLAYING CELENDER
def showCal():
    new_gui = Tk()
...
if __name__ == "__main__":
    ...
    cal = Label(gui, text="CALENDAR", bg="pink", font=("times", 40, 'bold'), padx=5, pady=5)
